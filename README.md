...
| [AIVP](https://aivp.dev) | AI Value Protocol — contracts, settlement, commercial trust (this) | aivp.dev |
| [AISOP](https://aisop.dev) | AI Standard Operating Protocol — flow program definition | aisop.dev |
| [SoulBot](https://soulbot.dev) | AI agents runtime and framework | soulbot.dev |
